...
Note: this class has been renamed WOOF_Inflector, to prevent potential conflicts with other WordPress 
plug-ins or themes

*/

class WOOF_Inflector
{
    // ------ CLASS METHODS ------ //
    ...
    */
    static function titleize($word, $uppercase = '')
    {
        ...
        return $uppercase(WOOF_Inflector::humanize(WOOF_Inflector::underscore($word)));
    }
    ...
    */
    ...
    /**
    * Converts a word "into-its-dashed-version"
    * 
    * Convert any "CamelCased" or "ordinary Word" into a
    * "dashed-word".
    * 
    * @access public
    * @static
    ...
    */
    ...
    {
        $word = WOOF_Inflector::camelize($word);
